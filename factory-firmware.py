...
def do_voltage():
     ...
     adc_scaling = { # tester 002 cal tables Nov 30 2021
         "+1.8V_T"   : 1.803 / 3056.0, # cal
         "+1.8V_SBY" : 1.803 / 3056.0, # infer
         "+1.2V_EC"  : 1.204 / 2032.0, # cal
         ...
         "+5V_LCD"   : 5.09 / 2031.0, # cal
         "V_BL"      : 3.73 / 639.0, # cal
         "VBUS"      : 4.98 / 1841.4, # cal
     }
     adc_ch = get_adc_ch_dict()

     nominal = {
          "+1.8V_T"   : [1.8, 1.68, 1.89], # sags under test current load
          "+1.8V_SBY" : [1.8, 1.68, 1.95],
          "+1.2V_EC"  : [1.2, 1.13, 1.26],
